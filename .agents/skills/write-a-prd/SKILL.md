---
name: write-a-prd
description: Create a GitHub issue PRD from a user's feature idea by exploring the repo, interviewing the user, resolving implementation decisions, defining user stories, scope, and test boundaries, then drafting the PRD from the standard template.
---
